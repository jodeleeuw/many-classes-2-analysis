...
percent_viewed_fit <- run_brms_model(
  "percent_viewed",
  bf(viewpct ~ condition + (1 | course_id/participant_id) + (0 + exposure_order | course_id)),
  submission_level_model_data,
  priors,
...
did_view_fit <- run_brms_model(
  "did_view",
  bf(initiate_playback ~ condition + (1 | course_id/participant_id) + (0 + exposure_order | course_id)),
  submission_level_model_data,
  priors,
